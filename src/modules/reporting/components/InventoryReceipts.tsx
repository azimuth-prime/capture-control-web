...
export function InventoryReceipts() {
  ...
  const { data, isFetching, isError, error, refetch } = useQuery({
    queryKey: ['inv-receipts', filter],
    queryFn: () => inventoryReportService.findReceiptsByDates(filter!).then((r) => r.data),
    enabled: filter !== null,
  })
  ...
  return (
    <div className="p-4">
      ...
      <h1 className="mb-4 text-2xl font-bold">Inventory Receipts</h1>
